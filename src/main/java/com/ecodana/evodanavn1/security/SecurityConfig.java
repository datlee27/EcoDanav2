...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .csrf(csrf -> csrf
                        .ignoringRequestMatchers("/oauth2/**", "/api/**", "/admin/vehicles/api/**", "/admin/api/**", "/admin/contracts/**", "/admin/payments/**", "/admin/discounts/**", "/staff/bookings/*/approve", "/staff/bookings/*/reject")
                )
                .formLogin(form -> form
                        .loginPage("/login")
